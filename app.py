...
if st.session_state['resume_text'] and st.session_state['chat_session'] is None:
    ...
    if api_key and api_key != "your_actual_api_key_here":
        ...
        st.session_state['chat_session'] = model.start_chat(history=[
            {"role": "user", "parts": [
                "You are a job candidate in an interview. Answer the interviewer's questions as if you are the candidate, using the following resume as your background. Answer must be in simple intermediate level english. The length of the answer and the formation should be very good such the the recruiter will hire you. Give answers a paragraphs brokendown into sections along wit teh section name.\n"
