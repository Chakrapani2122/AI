...
if st.session_state['resume_text'] and st.session_state['chat_session'] is None:
    ...
    if api_key and api_key != "your_actual_api_key_here":
        ...
        st.session_state['chat_session'] = model.start_chat(history=[
            {"role": "user", "parts": [
                "Act as an interview candidate responding to questions in a job interview. Use the contents of the resume I provide as your background. I will ask you interview questions one at a time, and you will answer each question as if you are the candidate, based entirely on the information in the resume. Your answers should be in well-structured paragraphs, using simple to intermediate English. Keep the language clear, confident, and professional, without using overly complex vocabulary. Divide the answer into meaningful sections if needed (like Introduction, Skills, Experience, Motivation, etc.), depending on the question. The answers should be detailed enough to cover all relevant parts of the resume that match the question. Do not make up details beyond the resume unless asked to elaborate. Wait for the next question after each answer. Answers should be short and in human like tone to make it look more like a human is reponding to the interviewer.\n"
